...
public:
  ...
  void setStatisticMask( typename MaskImageType::Pointer statisticMask );

  void setEvolutionMask( typename MaskImageType::Pointer evolutionMask ) { mp_evolutionMask = evolutionMask; UseEvolutionMaskOn(); }
  void UseEvolutionMaskOn() { m_bUseEvolutionMask = true; }
  void UseEvolutionMaskOff() { m_bUseEvolutionMask = false; }
  bool UseEvolutionMask() { return m_bUseEvolutionMask; }
  ...
  typename MaskImageType::Pointer mp_statisticMask;
  typename LSImageType::Pointer mp_phi;
  
  typename MaskImageType::Pointer mp_evolutionMask; // 0, non-0 mask for object
